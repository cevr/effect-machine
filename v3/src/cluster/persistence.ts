 ...
 * @module
 */
import { Context, type Effect, type Option, type Schedule } from "effect";
...
// ============================================================================
// Service tag (v3: Context.GenericTag)
// ============================================================================

/** Service tag for PersistenceAdapter — resolve from context for shared infra. */
export const PersistenceAdapter = Context.GenericTag<PersistenceAdapter>(
